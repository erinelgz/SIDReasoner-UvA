...
def write_snapshot(artifact_root: Path) -> None:
    ...
    report = [
        ...
        "sbatch --array=0-5 scripts/run_ablation_merge.sh",
        "sbatch --array=0-5 --export=MODE=common scripts/run_ablation_evaluation.sh",
        "sbatch --array=0-5 --export=MODE=native scripts/run_ablation_evaluation.sh",
        "sbatch --array=0-5 --export=MODE=reasoning_smoke scripts/run_ablation_evaluation.sh",
