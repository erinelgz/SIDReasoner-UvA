...
class MyRewardComputer:
    def __init__(self):
        ...
        sid_info_file = os.environ.get(
            "SID_INFO_FILE",
            str(repo_root / "data/Amazon/info/Office_Products_5_2016-10-2018-11.txt"),
        )
        self.sid_hash = construct_prefix_allowed_hashmap(sid_info_file)
